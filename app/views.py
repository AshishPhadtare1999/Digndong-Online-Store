...
def ProductAPI(request,pk=None):
    if request.method=='GET':
        ...
        if id is not None:
            ...
            ser=ProductSerial(obj)
            return Response({'message':'Data retrive Successfully..','result':ser.data})
        ...
        return Response({
            ...
            'messages':'Data Retrive Successfully..',
            'result':ser.data,
        })
    ...
    if request.method=='DELETE':
        ...
        obj.delete()
        return Response({'messages':'Delete successfuly..'})
